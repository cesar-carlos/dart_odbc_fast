...
pub use ffi::{
    ...
    odbc_execute_async_params, odbc_execute_async_params_options, odbc_get_error,
    odbc_get_structured_error, odbc_get_structured_error_for_connection, odbc_init,
