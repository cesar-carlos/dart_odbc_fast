...
pub use ffi::{
    ...
    odbc_execute_async_params, odbc_get_error, odbc_get_structured_error,
    odbc_get_structured_error_for_connection, odbc_init, odbc_savepoint_create,
    odbc_savepoint_release, odbc_savepoint_rollback, odbc_stream_poll_async,
