...
void main() {
  ...
  group('Named parameters integration', () {
    ...
    test('sync executeQueryNamed supports more than five parameters', () async {
      if (skipReason != null || locator == null) return;
    ...
    test('sync executeQueryNamed reuses repeated placeholder values', () async {
      if (skipReason != null || locator == null) return;
    ...
    test(
      ...
      () async {
        ...
        result.fold(
          ...
          (_) =>
              fail('sync executePreparedNamed should support >5 named params'),
        );
