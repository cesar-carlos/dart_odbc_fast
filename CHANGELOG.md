...
- Zero-copy FFI double-free (per-buffer Finalizable)

## [4.3.2] - 2026-06-15

### Fixed

- FFI export check script multiline lookup regex
- Benchmark CI test-helpers feature for bulk_operations_bench
